...
@Component({
  ...
  styleUrls: ['./autocorrelation.component.scss'],
})
export class AutocorrelationComponent implements OnInit, OnChanges {
  ...
  private initializeChart(): void {
    ...
    this.yScale = d3
      .scaleLinear()
      .domain([
        d3.max(this.data, (d) => d.y_value) + 0.005,
        d3.min(this.data, (d) => d.y_value) - 0.005,
      ])
